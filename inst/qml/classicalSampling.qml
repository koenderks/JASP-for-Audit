...
Form {
	...
	Section {
		expanded: true
		title: samplingMethod.expanded ? qsTr("<b>Sampling method</b>") : qsTr(
											 "Sampling method")
		id: samplingMethod
		...
		RadioButtonGroup {
			...
			Flow {
				...
				ColumnLayout {
					spacing: 5
					RadioButton {
						text: qsTr("Simple random sampling")
						name: "simplerandomsampling"
						id: simplerandomsampling
						checked: true
					}
					CheckBox {
						text: qsTr("Allow duplicate records")
						name: "allowDuplicates"
						Layout.leftMargin: 20
						enabled: simplerandomsampling.checked
					}
				}
				ColumnLayout {
					RadioButton {
