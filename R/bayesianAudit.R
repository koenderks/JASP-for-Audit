bayesianAudit <- function(jaspResults, dataset, options, ...){
    ### TITLE ###
    jaspResults$title <- "Bayesian Audit Workflow"
    ### PROCEDURE ###
...
.bayesianPlanning <- function(dataset, options, jaspResults){
  ...
  if(options[["explanatoryText"]] && is.null(jaspResults[["planningContainer"]][["planningParagraph"]])){
    ...
    jaspResults[["planningContainer"]][["planningParagraph"]]$dependOnOptions(c("expectedPercentage", "expectedErrors", "expectedNumber", "planningModel", "IR", "CR", "materialityPercentage", "confidence", "materialityValue", "materiality"))
  }
  ...
  if(options[['priorPlot']] && jaspResults[["ready"]]$object)
  {
      if(is.null(jaspResults[["planningContainer"]][["priorPlot"]]))
      {
          ...
          jaspResults[["planningContainer"]][["priorPlot"]]		  $dependOnOptions(c("IR", "CR", "confidence", "materialityPercentage", "expectedErrors", "priorPlotLimit", "priorPlot", "priorPlotAdditionalInfo", "priorPlotExpectedPosterior", 
...
.bayesianSelection <- function(options, jaspResults){
  ...
  if(options[["explanatoryText"]]){
    ...
    jaspResults[["selectionContainer"]][["samplingParagraph"]]$dependOnOptions(c("selectionType", "selectionMethod"))
  }
...
.bayesianEvaluation <- function(options, jaspResults){
  ...
  if(options[["explanatoryText"]]){
    ...
    jaspResults[["evaluationContainer"]][["resultParagraph"]]$dependOnOptions(c("IR", "CR", "confidence", "auditResult", "materialityPercentage", "estimator", "materialityValue", "materiality"))
  }
  ...
  if(options[['evaluationInformation']] && runEvaluation)
  {
      if(is.null(jaspResults[["evaluationInformation"]]))
      {
          ...
          jaspResults[["evaluationContainer"]][["evaluationInformation"]]		$dependOnOptions(c("IR", "CR", "confidence", "auditResult", "evaluationInformation", "materialityPercentage", "estimator",
  ...
  if(options[['priorAndPosteriorPlot']] && runEvaluation)
  {
      if(is.null(jaspResults[["evaluationContainer"]][["priorAndPosteriorPlot"]]))
      {
        ...
        jaspResults[["evaluationContainer"]][["priorAndPosteriorPlot"]]		$dependOnOptions(c("IR", "CR", "confidence", "priorAndPosteriorPlotLimit", "priorAndPosteriorPlot", "priorAndPosteriorPlotAdditionalInfo", "materialityPercentage", "auditResult",
...
.bayesianConclusion <- function(options, jaspResults){
  ...
  if(options[["explanatoryText"]] && jaspResults[["runEvaluation"]]$object){
    ...
    jaspResults[["conclusionContainer"]][["conclusionParagraph"]]$dependOnOptions(c("IR", "CR", "confidence", "auditResult", "materialityPercentage", "estimator", "materialityValue", "sampleFilter", "materiality"))
  }
  # Finsh conclusion
}
