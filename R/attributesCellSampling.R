...
attributesCellSampling <- function(jaspResults, dataset, options, state=NULL)
{
    ...
    jaspResults$title               <- "Attributes Cell Sampling"
    ...
    .cellSamplingTable(dataset, options, jaspResults, interval)
